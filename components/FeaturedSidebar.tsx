                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0 flex flex-col justify-center gap-0.5">
                                    ...
                                    <div className="flex items-center gap-1 mt-0.5">
                                        <span className={`text-[8px] font-black uppercase tracking-wider px-1.5 py-0.5 rounded border ${diffColors}`}>
                                        ...
                                        {(() => {
                                            ...
                                            return (
                                                <span className={`text-[8px] font-black uppercase tracking-wider px-1.5 py-0.5 rounded border ${neutralStyle} flex items-center gap-1`}>
